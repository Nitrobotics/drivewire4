#!/bin/bash
# DriveWire 4 - macOS Launch Script (Lite UI)
# Uses simpler Swing-based UI instead of full SWT UI
# Note: Swing doesn't need -XstartOnFirstThread
