...
public class ServerConfigWin extends Dialog {
	...
	private HashMap<String, String> getChangedValues() 
	{
		...
		addIfChanged(res,"UIPort",String.valueOf(this.textUIPort.getSelection()));
		addIfChanged(res,"DiskLazyWriteInterval",String.valueOf(this.textLazyWrite.getSelection()));
