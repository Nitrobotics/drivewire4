...
public class SerialPage extends WizardPage
{
	...
	public void createControl(Composite parent)
	{
		...
		// The old icon (system-search-4.png) is not present in the resources bundle.
		// Use an existing "refresh/rescan" icon instead.
		...
		// The old icon (edit-add-2.png) is not present in the resources bundle.
